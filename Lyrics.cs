    ...
    public class Lyrics : StoryboardObjectGenerator
    {
        ...
        public void generatePerLine(FontGenerator font, SubtitleSet subtitles, StoryboardLayer layer, bool additive)
        {
            foreach (var line in subtitles.Lines)
            {
                ...
                //sprite.Move(line.StartTime - 200, line.StartTime, position - new Vector2(100 , 0), position + new Vector2(100 , 0));
                ...
                foreach (var line in subtitleLine.Text.Split('\n'))
                {
                    ...
                    foreach (var letter in line)
                    {
                        ...
                        if (!texture.IsEmpty)
                        {
                            ...
                            sprite.Move(subtitleLine.StartTime - 200, subtitleLine.StartTime, position - new Vector2(40 , 0), position - new Vector2(5 , 0));

                            sprite.Move(subtitleLine.StartTime, subtitleLine.EndTime - 200, position - new Vector2(5 , 0), position + new Vector2(5 , 0));

                            sprite.Move(subtitleLine.EndTime - 200, subtitleLine.EndTime, position + new Vector2(5 , 0), position + new Vector2(40 , 0));
