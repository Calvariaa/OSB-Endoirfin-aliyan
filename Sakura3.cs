...
{
    public class sakura3 : StoryboardObjectGenerator
    {
        [Configurable]
        public string Path = "sb/SAKURA1.png";
        public string Path2 = "sb/SAKURA2.png";
        public string Path3 = "sb/SAKURA3.png";
        ...
        public void sbukura1()
        {
            ...
            for (var i = 0; i < ParticleCount; i++)
            {
                ...
                //var particle2 = layer.CreateSprite(Path2, Origin);
                //var particle3 = layer.CreateSprite(Path3, Origin);
        ...
        public void sbukura2()
        {
            ...
            for (var i = 0; i < ParticleCount; i++)
            {
                ...
                var particle = layer.CreateSprite(Path2, Origin);
                //var particle2 = layer.CreateSprite(Path2, Origin);
                //var particle3 = layer.CreateSprite(Path3, Origin);
        ...
        public void sbukura3()
        {
            ...
            for (var i = 0; i < ParticleCount; i++)
            {
                ...
                var particle = layer.CreateSprite(Path3, Origin);
                //var particle2 = layer.CreateSprite(Path2, Origin);
                //var particle3 = layer.CreateSprite(Path3, Origin);
